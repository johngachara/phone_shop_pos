...
import {setSearchResults} from "components/redux/actions/shopActions.js";
...
const useSearchScreens = (searchParam) => {
    ...
    useEffect(() => {
        const handleSearch = async () => {
            ...
            try {
                ...
                dispatch(setSearchResults(info));
            } catch (err) {
                toast({
                    title: "Error",
                    position: "top",
...
export default useSearchScreens;